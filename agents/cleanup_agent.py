...
def cleanup_agent(classified_instruction: Dict[str, Any], slide_context: Dict[str, Any]) -> list[Dict[str, Any]]:
    ...
    for sub_task in sub_tasks:
        ...
        try:
            ...
            # logging.info(f"cleanup_agent description: {description}")
        except Exception as e:
            logging.error(f"Error generating description for cleanup task: {e}")
        ...
        logging.info(f"cleanup_agent processed sub-task: {action} for slide {slide_number}")
