        ...
        await PowerPoint.run(async (context) => {
            ...
            for (let s = 0; s < slideCount; s++) {
                ...
                try {
                  ...
                  //   shapes.load("items/id, items/name, items/left, items/top, items/width, items/height, items/type, items/altTextDescription, items/fill/foregroundColor");
                  ...
                  await context.sync();
                    ...
                    for (let i = 0; i < shapesItems.length; i++) {
                        ...
                        const shapeData = {
                            ...
                            //   font: { name: null, size: null, bold: false, italic: false, color: null},
                            textAlign: null,
                          //   fillColor: shape.fill?.foregroundColor?.color || null
                        };
                    ...
                    if (shapesToGetTextFrom.length > 0) {
                        ...
                        for (const shape of shapesToGetTextFrom) {
                          ...
                          // shape.load("textFrame/textRange/text, textFrame/textRange/font/name, textFrame/textRange/font/size, textFrame/textRange/font/bold, textFrame/textRange/font/italic, textFrame/textRange/font/color, textFrame/textRange/textAlign");
                      }
                        await context.sync();
                        ...
                        for (const shape of shapesToGetTextFrom) {
                            ...
                            try {
                                ...
                                if (tr) {
                                  ...
                                  //   entry.font.color = tr.font.color || null;
                                  //   entry.textAlign = tr.textAlign || null;
                                }
                            } catch (textError) {
